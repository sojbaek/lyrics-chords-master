...
const fonts = ["18px serif", "16px serif", "12px serif", "10px serif","8px serif"];
...
const GChord = props => {
  ...
  return <canvas ref={canvasRef} {...rest} width={CHORDWIDTH} height={CHORDHEIGHT} />
}

export default GChord